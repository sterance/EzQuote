...
export const Templates: React.FC = () => {
  const { groups, updateGroup, deleteGroup, addGroup, updateGroupFills, importData, reorderGroups, clearAll, editingGroupId, clearEditingGroupId } = useTemplateStore();
